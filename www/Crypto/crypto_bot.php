		...
		<table>
			<thead> 
				...
				<tr>
					...
					<td> Daily </td>
					<td> Google </td>
					<td> Количество торгующих бирж </td>	<!-- должна быть активная ссылка на страницу с перечнем бирж  пр. https://coinmarketcap.com/currencies/bitcoin/#markets  -->
					<td> Дата начала торгов </td>	
					<td> Цена на начало торгов, $ </td>	
					<td> Цена сегодня, $ </td>	
					<td> Динамика цены за всю историю, $ </td>	
				</tr>
			</thead>
			<tbody>
	<!-- /Шапка таблицы -->
